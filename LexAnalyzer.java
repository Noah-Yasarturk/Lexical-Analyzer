...
public class LexAnalyzer {
	...
	public static boolean isKeyWord(String a) {
		String keywords[] = { "byte", "class", "do", "extends", "for", "import", "long", "private", "short", "switch",
				"throws", "volatile", "assert", "case", "const", "double", "final", "goto", "instanceof", "native",
				"protected", "static", "synchronized", "transient", "while", "boolean", "catch", "continue", "else",
				"finally", "if", "int", "new", "public", "strictfp", "this", "try", "break", "char", "default", "enum",
	...
	public static void lex(char[] arr) {
		...
		for (int i = 0; i < arr.length; i++) {
			...
			if (arr[i] == '=') {
				...
				System.out.println("{ \t\t\tleft_curly");
			} else if (arr[i] == '}') {
				System.out.println("} \t\t\tright_curly");
			} else if (arr[i] == ')') {
